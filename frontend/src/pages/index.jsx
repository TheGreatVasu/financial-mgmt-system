  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="pt-16 grid grid-cols-1 lg:grid-cols-2 flex-1">
        {/* Left: Product intro with gradient + illustration */}
        <div className="relative overflow-hidden order-1 lg:order-none flex items-center justify-center py-16 px-8 animate-fade-left">
          ...
          <div className="relative max-w-xl text-white">
            ...
            <h1 className="mt-2 text-3xl md:text-4xl font-bold leading-tight">Manage, analyze, and forecast your business finances smarter.</h1>
            <p className="mt-4 text-white/85 text-base md:text-lg">Login to access your personalized financial dashboard with live KPIs, collections insights, and forecasting tools.</p>
            <img src="/feature-analytics.svg" alt="Analytics" className="mt-8 w-full max-w-md drop-shadow-2xl" />
          </div>
        </div>
        ...
        <div className="flex items-center justify-center px-6 py-12 animate-fade-right">
          <div className="w-full max-w-md">
            ...
            <div className="mb-4 text-center">
              ...
              <p className="text-sm text-secondary-600">Let’s continue optimizing your business performance.</p>
            </div>
            ...
            <div className="rounded-3xl border border-secondary-200/70 bg-white/80 backdrop-blur-md shadow-[0_20px_60px_-20px_rgba(2,6,23,0.15)]">
              <div className="p-6 space-y-4">
                ...
                <form onSubmit={onSubmit} className="space-y-4">
                  ...
                  <button className="w-full h-11 rounded-xl text-white text-sm font-medium bg-gradient-to-r from-primary-600 via-indigo-600 to-sky-600 shadow-[0_12px_40px_-10px_rgba(37,99,235,0.6)] hover:shadow-[0_16px_50px_-10px_rgba(37,99,235,0.75)] transition-all" disabled={loading}>
            ...
            <div className="mt-4 text-center text-sm text-secondary-600">New to FinFlow? <Link className="text-primary-600 hover:underline" to="/signup">Create an account</Link></div>
          </div>
        </div>
      </main>
      <Footer />
