...
export default function PaymentsPage() {
  ...
  async function loadInvoices() {
    ...
    try {
      ...
      // Merge legacy sales invoices and new app invoices so all are available for payments
  ...
  function onInvoiceSelect(invoiceId) {
    const invoice = invoices.find(inv => getInvoiceIdentifier(inv) === invoiceId)
    if (invoice) {
      setForm(prev => ({
        ...prev,
        // Always store canonical identifier so backend can resolve both legacy and new invoices
